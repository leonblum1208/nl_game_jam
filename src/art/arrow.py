...
class Arrow(BaseModel):
    ...
    def draw(self, screen, pos_x, pos_y):
        ...
        pygame.draw.line(
            ...
            (pos_x, pos_y),
            (
                pos_x + dx * (self.length - self.head_size),
                pos_y + dy * (self.length - self.head_size),
            ),
            2,
        )
        ...
        arrowhead = [
            ...
            (
                pos_x + dx * (self.length - self.head_size) - dy * self.head_size,
                pos_y + dy * (self.length - self.head_size) + dx * self.head_size,
            ),
            (
                pos_x + dx * (self.length - self.head_size) + dy * self.head_size,
                pos_y + dy * (self.length - self.head_size) - dx * self.head_size,
